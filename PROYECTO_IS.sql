...
/*-- Crear la tabla HISTORIAL con relación a USUARIO
CREATE TABLE HISTORIAL (
    ...
    CONSTRAINT FK_HISTORIAL_HORARIO FOREIGN KEY (ID_HORARIO) REFERENCES HORARIO(ID_HORARIO),
...
VALUES (1, 'Juan', 'Pérez', 'Gómez', 'clave123');

INSERT INTO USUARIO (ID_USUARIO, NOMBRE, APELLIDO_PATERNO, APELLIDO_MATERNO, CONTRASENA)
VALUES (2, 'Ana', 'López', 'Díaz', 'segura456');

INSERT INTO USUARIO (ID_USUARIO, NOMBRE, APELLIDO_PATERNO, APELLIDO_MATERNO, CONTRASENA)
VALUES (3, 'Carlos', 'Ramírez', 'Torres', 'miPass789');

-- Insertar registros en HISTORIAL con los usuarios
/*INSERT INTO HISTORIAL (ID_HISTORIAL, ID_HORARIO, FECHA, ID_USUARIO)
VALUES (1, 10, TO_DATE('2023-10-01', 'YYYY-MM-DD'), 1);

INSERT INTO HISTORIAL (ID_HISTORIAL, ID_HORARIO, FECHA, ID_USUARIO)
VALUES (2, 11, TO_DATE('2023-10-02', 'YYYY-MM-DD'), 2);

INSERT INTO HISTORIAL (ID_HISTORIAL, ID_HORARIO, FECHA, ID_USUARIO)
VALUES (3, 12, TO_DATE('2023-10-03', 'YYYY-MM-DD'), 3);
*/
CREATE TABLE HISTORIAL (
    ...
    CONSTRAINT HISTORIAL_ID_INCIDENCIA_FK FOREIGN KEY (ID_INCIDENCIA) REFERENCES INCIDENCIA(ID_INCIDENCIA),
    CONSTRAINT HISTORIAL_FKS_CK CHECK (
        (CASE WHEN ID_HORARIO IS NOT NULL THEN 1 ELSE 0 END +
         ...
         CASE WHEN ID_ASIGNACION IS NOT NULL THEN 1 ELSE 0 END +
         CASE WHEN ID_INCIDENCIA IS NOT NULL THEN 1 ELSE 0 END) = 1
    )
);
...
-- Registro de una ruta
INSERT INTO HISTORIAL (ID_HISTORIAL, FECHA_REGISTRO, ID_RUTA, ID_USUARIO) 
VALUES (2, SYSDATE, 2, 2);

-- Registro de una asignación de tren
INSERT INTO HISTORIAL (ID_HISTORIAL, FECHA_REGISTRO, ID_ASIGNACION, ID_USUARIO) 
VALUES (3, SYSDATE, 1, 1);

-- Registro de una incidencia
INSERT INTO HISTORIAL (ID_HISTORIAL, FECHA_REGISTRO, ID_INCIDENCIA, ID_USUARIO) 
VALUES (4, SYSDATE, 2, 3);
